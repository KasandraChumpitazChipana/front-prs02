...
const Justifications = () => {
  ...
  const createJustification = async () => {
    const result = await MySwal.fire({
      ...
      text: '¿Estás seguro de que deseas crear esta justificación?',
      icon: 'question',
  ...
  return (
    <div className="wrapper">
      ...
      if (result.isConfirmed) changeJustificationStatus(justification.id, 'APROBADA');
    }}
                                        title="Aprobar"
                                      >
      ...
      if (result.isConfirmed) changeJustificationStatus(justification.id, 'RECHAZADA');
    }}
                                        title="Rechazar"
                                      >
                                        <FontAwesomeIcon icon={faTimes} />
                                      ...
                                      <button 
                                        ...
                                        onClick={async () => {
      const result = await MySwal.fire({
        title: '¿Completar justificación?',
        icon: 'info',
        showCancelButton: true,
        confirmButtonText: 'Sí, completar',
        cancelButtonText: 'Cancelar'
      });
      if (result.isConfirmed) changeJustificationStatus(justification.id, 'COMPLETED');
    }}
                                        title="Completar"
                                      >
                                        <FontAwesomeIcon icon={faCheck} />
